...
project = 'DEXBot'
copyright = 'ChainSquad GmbH 2017, Codaone Oy 2018'
author = 'Fabian Schuh, Codaone Oy'
...
latex_documents = [
  (master_doc, 'DEXBot.tex', 'DEXBot Documentation',
   'Fabian Schuh, DEXBot developers', 'manual'),
]
...
texinfo_documents = [
  (master_doc, 'DEXBot', 'DEXBot Documentation',
   author, 'DEXBot', 'A bot framework for the BtiShares DEX',
   'Miscellaneous'),
]
