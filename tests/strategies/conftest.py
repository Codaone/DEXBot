...
@pytest.fixture(scope='session')
def ro_worker_name():
    """ Fixture to share relative Orders worker name
    """
    return 'ro-worker'
...
@pytest.fixture
def config_only_base(config, ro_worker_name, account_only_base):
...
@pytest.fixture
def config_1_sat(ro_worker_name, bitshares, account_1_sat):
...
@pytest.fixture
def base_worker(bitshares, ro_worker_name, storage_db):
    worker_name = ro_worker_name
    workers = []
